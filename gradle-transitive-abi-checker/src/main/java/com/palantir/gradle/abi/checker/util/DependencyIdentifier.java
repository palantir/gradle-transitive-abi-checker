...
public final class DependencyIdentifier {
    ...
    public static String convertToSimpleIdentifier(ResolvedArtifactResult resolvedArtifact) {
        return resolvedArtifact.getId().getComponentIdentifier().getDisplayName();
    }
